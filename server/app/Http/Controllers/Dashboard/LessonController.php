...
use App\Http\Requests\Dashboard\Lessons\ReorderLessonsRequest;
use App\Http\Requests\Dashboard\Lessons\StoreLessonRequest;
...
class LessonController extends Controller
{
    ...
    public function store(StoreLessonRequest $request, Course $course, CreateLessonAction $create)
    {
        $this->authorize('view', $course);
    ...
    public function update(UpdateLessonRequest $request, Lesson $lesson, UpdateLessonAction $update)
    {
        $this->authorize('update', $lesson);
    ...
    public function reorder(ReorderLessonsRequest $request, Course $course): JsonResponse
    {
        $this->authorize('update', $course);

        $modules = collect($request->validated('modules', []))
